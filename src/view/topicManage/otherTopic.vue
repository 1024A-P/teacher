<template>
  <div class="other-manage">
    ...
    <div class="line-title other-info-title">其它</div>
    <!-- 查询 -->
    <div class="other-info-search">
      <!-- 查询输入参数 -->
      <div class="info-input">
        <wj-input v-model="form.txtId" label="题号" maxlength="30" placeholder="请输入题号" clearable></wj-input>
        <wj-input class="mgl20" v-model="form.type" label="题型" maxlength="30" placeholder="请输入题型名字" clearable></wj-input>
    ...
    <wj-table :tableData="testData">
      ...
      <el-table-column prop="title" label="题目" align="center" :show-overflow-tooltip="true"></el-table-column>
