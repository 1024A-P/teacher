<template>
  <div class="fill-manage">
    <!-- <el-button type="primary">路由</el-button> -->
    <div class="line-title fill-info-title">填空题管理</div>
    <!-- 查询 -->
    <div class="fill-info-search">
      <!-- 查询输入参数 -->
    ...
    <wj-table :tableData="testData">
      <el-table-column prop="txtId" label="题号" width="80" align="center"></el-table-column>s
